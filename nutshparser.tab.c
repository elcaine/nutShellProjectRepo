...
static const char *const yytname[] =
{
  ...
  "PIPE", "END_OF_FILE", "END", "$accept", "cmd_line", YY_NULLPTR
};
#endif
...
#line 28 "nutshparser.y"
                                                {runCDspc((yyvsp[-2].string), (yyvsp[-1].string));			return 1; }
...
#line 32 "nutshparser.y"
                                                                                                        {genCommandOne((yyvsp[-1].string));							return 1; }
#line 1429 "nutshparser.tab.c"
    break;

  case 17:
#line 33 "nutshparser.y"
                                                                                                {genCommandTwo((yyvsp[-2].string), (yyvsp[-1].string));						return 1; }
#line 1435 "nutshparser.tab.c"
    break;

  case 18:
#line 34 "nutshparser.y"
                                                                                        {genCommandTre((yyvsp[-3].string), (yyvsp[-2].string), (yyvsp[-1].string));					return 1; }
#line 1441 "nutshparser.tab.c"
    break;

  case 19:
#line 35 "nutshparser.y"
                                                                                {genCommandFor((yyvsp[-4].string), (yyvsp[-3].string), (yyvsp[-2].string), (yyvsp[-1].string));				return 1; }
#line 1447 "nutshparser.tab.c"
    break;

  case 20:
#line 36 "nutshparser.y"
                                                                        {genCommandFiv((yyvsp[-5].string), (yyvsp[-4].string), (yyvsp[-3].string), (yyvsp[-2].string), (yyvsp[-1].string));			return 1; }
#line 1453 "nutshparser.tab.c"
    break;

  case 21:
#line 37 "nutshparser.y"
                                                                {genCommandSix((yyvsp[-6].string), (yyvsp[-5].string), (yyvsp[-4].string), (yyvsp[-3].string), (yyvsp[-2].string), (yyvsp[-1].string));		return 1; }
#line 1459 "nutshparser.tab.c"
    break;

  case 22:
#line 38 "nutshparser.y"
                                                                {genCommand   ((yyvsp[-7].string), (yyvsp[-6].string), (yyvsp[-5].string), (yyvsp[-4].string), (yyvsp[-3].string), (yyvsp[-2].string), (yyvsp[-1].string));	return 1; }
