...
static const char *const yytname[] =
{
  ...
  "PRINTENV", "CD", "STRING", "ALIAS", "END", "$accept", "cmd_line", YY_NULLPTR
};
#endif
...
{
      -3,    -5,    -2,     2,     3,     4,     5,     6,    -1,    15,
      -6,    -6,     7,     8,     9,    -6,    10,    13,    -6,    -6,
      -6,    12,    -6,    -6,    14,    -6,    -6
};
...
{
       1,     2,     3,     4,     5,     6,     7,    10,     8,    17,
      11,    18,    12,    13,    14,    19,    16,    15,    21,    20,
       0,    22,    23,    24,    25,     0,    26
};
...
int runCD(char* arg) {
	...
	*/
	...
	/*/ barebones cd code
	if (arg == NULL)
		printf("Not sure how this happened homeboi!\n") :
	else
		if (chdir(arg) != 0)
			perror("mas problems here too!\n");
	return 1;
	*/
	/*
